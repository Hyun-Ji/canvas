...
<html lang="en">
<head>
    <title>Code coverage report for father/lib/package.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">father/lib/package.js</span></h1>
    <h2>
        ...
        Lines: <span class="metric">95.97% <small>(119 / 124)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../index.html">All files</a> &#187; <a href="index.html">father/lib/</a> &#187; package.js</div>
</div>
<div class="body">
...
&nbsp;
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (Array.isArray(pkg.output)) {
...
&nbsp;
        ...
        if (current.charAt(0) !== '.') {
          ...
          <span class="missing-if-branch" title="if path not taken" >I</span>if (!dpkg) {
<span class="cstat-no" title="statement not covered" >            throw new Error(current + ' not found but required');</span>
          }
          return previous;
        }
&nbsp;
...
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (!this.packages[pkg.id]) {
...
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!this._parsed &amp;&amp; !this._running) <span class="cstat-no" title="statement not covered" >this._parse();</span>
    return id === this.id ? this : this.packages[id];
  },
&nbsp;
  getPackages: <span class="fstat-no" title="function not covered" >function() {</span>
<span class="cstat-no" title="statement not covered" >    if (this.father) {</span>
<span class="cstat-no" title="statement not covered" >      return this.father.getPackages();</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (!this._parsed &amp;&amp; !this._running) <span class="cstat-no" title="statement not covered" >this._parse();</span></span>
<span class="cstat-no" title="statement not covered" >    return this.packages;</span>
  },
&nbsp;
      ...
      Object.defineProperty(that, key, {
        get: function() {
          ...
          if (key === 'dependencies') {
            ...
            return pkg ? pkg._pkg[key] : <span class="branch-1 cbranch-no" title="branch not covered" >'';</span>
          }
        },
        configurable: true
      });
